...
export const getMaxWordFrequency = (minFrequency: number, words: string[], usage: Record<string, number>) => words.reduce((result, word) => (usage[word] > result ? usage[word] : result), minFrequency + 1);
